...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.rateLimitLabel = QtWidgets.QLabel(parent=self.defaultConfigGroupBox)
        self.rateLimitLabel.setObjectName("rateLimitLabel")
        self.gridLayout.addWidget(self.rateLimitLabel, 2, 0, 1, 1)
        self.rateLimitComboBox = QtWidgets.QComboBox(parent=self.defaultConfigGroupBox)
        self.rateLimitComboBox.setObjectName("rateLimitComboBox")
        self.rateLimitComboBox.addItems(["60", "120", "240"])
        self.gridLayout.addWidget(self.rateLimitComboBox, 2, 1, 1, 1)
        ...
        self.btnFillPlaceholder = QtWidgets.QPushButton(parent=self.utilitiesGroupBox)
        self.btnFillPlaceholder.setObjectName("btnFillPlaceholder")
        self.gridLayout_7.addWidget(self.btnFillPlaceholder, 0, 2, 1, 1)
        self.testModeCheckBox = QtWidgets.QCheckBox(parent=self.utilitiesGroupBox)
        self.testModeCheckBox.setObjectName("testModeCheckBox")
        self.gridLayout_7.addWidget(self.testModeCheckBox, 1, 1, 1, 2)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.rateLimitLabel.setText(_translate("Dialog", "请求速率"))
        self.rateLimitComboBox.setToolTip(_translate("Dialog", "查询请求速率 (req/min)"))
        ...
        self.btnFillPlaceholder.setToolTip(_translate("Dialog", "Re-query fields that have placeholder values (no-image, no-notes, etc.)"))
        self.btnFillPlaceholder.setText(_translate("Dialog", "Fill Placeholder"))
        self.testModeCheckBox.setToolTip(_translate("Dialog", "Test mode: only process first 100 words"))
        self.testModeCheckBox.setText(_translate("Dialog", "测试模式（前100词）"))
